	...
	<div class="text-center">
		<form action="" class="form-horizontal" id="payPassword_from" method="post">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<input type="password" class="form-control" name="confirmpayPassword" id="confirmpayPassword" placeholder="确认支付密码" required data-number="true" data-equal-to="#payPassword">
				</div>
			</div>
