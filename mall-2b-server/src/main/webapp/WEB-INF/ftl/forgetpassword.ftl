...
<meta charset="utf-8" />
		...
		.div-login{width:350px;height:300px;border:1px solid #2679b9;margin:0px auto;margin-top:80px;background-color:white}
	...
	<div class="div-login">
			...
			<form action="#" id="form_cl" name="form_cl">
				...
				<div class="form-group other-group" style="height:65px">
						...
						<input class="form-control" type="text" placeholder=" 输入注册邮箱" name="email" id="email"
							required data-required-message="邮箱不能为空"
							data-email="true" data-email-message="邮箱格式不正确" />
				</div>
					
				
				<div class="form-group other-group" style="height:30px">
					<input type="submit" class="btn sub-btn" value="立 即 找 回" />
