...
<head>
	...
	<script src="${IncPath}/js/TrusteeControlHongkong.js"></script>
...
<!--<![endif]-->
	...
	<#else>
		...
		<input type="hidden" name="goodsId" id="goodsId" value="7">
		...
		<div class="big-left">
			<ul class="ul-left">
				...
				<p class="left-p">托管规格：</p>
					<ul class="ul-left0">
						<li><button type="button" class="btn btn-default" value="0" id="337">1U</button></li>
						<li><button type="button" class="btn btn-default" value="2400" id="338">2U</button></li>
						<li><button type="button" class="btn btn-default" value="4000" id="339">4U</button></li>
						<li><button type="button" class="btn btn-default" value="16800" id="340">半机柜</button></li>
						<li><button type="button" class="btn btn-default" value="35200" id="341">整机柜</button></li>
					</ul>
				</li>
				<li>
				<p class="left-p">机柜功率：</p>
					<ul class="ul-left1">
						<li><button type="button" class="btn btn-default" value="0" id="342">300W</button></li>
						<li><button type="button" class="btn btn-default" value="28000" id="343">4A/220V</button></li>
						<li><button type="button" class="btn btn-default" value="50000" id="344">8A/220V</button></li>
					</ul>
				</li>
				<li>
				<p class="left-p">国际带宽：</p>
					<ul class="ul-left2">
						<li><button type="button" class="btn btn-default" value="0" id="345">3Mbps</button></li>
						<li><button type="button" class="btn btn-default" value="0" id="346">5Mbps</button></li>
						<li><button type="button" class="btn btn-default" value="0" id="347">10Mbps</button></li>
					</ul>
				</li>
			</ul>
			...
			<p class="left-p">公网IP：</p>
					<ul class="ul-ip"> 
						<li style="height:35px">
							...
							<input type="text" class="form-control ip" style="width:50px;position:relative;top:3px;text-align:center;display:inline-block" value="1" disabled id="348">
			...
			<div class="buy-num">
				<p class="left-p">购买数量：</p>
					...
					<span id="ip-tip" style="position:relative;left:150px;top:-168px">增加600元/个/年  最多增加13个</span>
			</div>
		</div>
