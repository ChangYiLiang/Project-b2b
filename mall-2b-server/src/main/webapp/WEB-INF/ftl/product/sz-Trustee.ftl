...
<head>
	...
	<script src="${IncPath}/js/TrusteeControlShengZhen.js"></script>
		...
		<div class="big-left">
			<ul class="ul-left">
				...
				<p class="left-p">托管规格：</p>
					<ul class="ul-left0">
						<li><button type="button" class="btn btn-default" value="0" id="325">1U</button></li>
						<li><button type="button" class="btn btn-default" value="0" id="326">2U</button></li>
						<li><button type="button" class="btn btn-default" value="2000" id="327">4U</button></li>
						<li><button type="button" class="btn btn-default" value="6300" id="328">半机柜</button></li>
						<li><button type="button" class="btn btn-default" value="10900" id="329">整机柜</button></li>
					</ul>
				</li>
				<li>
				<p class="left-p">机柜功率：</p>
					<ul class="ul-left1">
						<li><button type="button" class="btn btn-default" value="0" id="330">300W</button></li>
						<li><button type="button" class="btn btn-default" value="24000" id="331">5A/220V</button></li>
						<li><button type="button" class="btn btn-default" value="48000" id="332">10A/220V</button></li>
					</ul>
				</li>
				<li>
				<p class="left-p">线路：</p>
					<ul class="ul-left2">
						<li><button type="button" class="btn btn-default" value="0" id="333">电信单线</button></li>
						<li><button type="button" class="btn btn-default" value="1000" id="334">多线GBP</button></li>
					</ul>
				</li>
				<li>
				<p class="left-p">国际带宽：</p>
					<ul class="ul-left3">
						<li><button type="button" class="btn btn-default" value="0" id="335">100M</button></li>
					</ul>
				</li>
			</ul>
			...
			<p class="left-p">公网IP：</p>
					<ul class="ul-ip"> 
						<li style="height:35px">
							...
							<input type="text" class="form-control ip" style="width:50px;position:relative;top:3px;text-align:center;display:inline-block" value="1" disabled id="336">
			...
			<div class="buy-num">
				<p class="left-p">购买数量：</p>
					...
					<span id="ip-tip" style="position:relative;left:150px;top:-168px">增加800元/个/年  最多增加13个</span>
			</div>
		</div>
		<div class="big-right">
