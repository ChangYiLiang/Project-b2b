...
<script type="text/javascript" src="${IncPath}/js/IBM5458i21.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							<option selected="selected">X3250 M5 5458I21</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="7700" id="114">System x3250 M5 5458I21</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：System x3250 M5 5458I21属于单路1U机架服务器，仅支持1颗CPU</a>
								<select class="form-control selectpicker">
						   ...
						   <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="128">ServerRaid C100 Raid 0,1,10</option>
								</select>
							</li>
							 <li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">联想（iBM）x3250 M5 5458i21</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> X3250 M5 5458I21 是入门级一路机架式服务器。为预算有限的中小企业提供了一条享受高品质IT基础架构的选择。服务器采用了英特尔Xeon E3-1220 v3处理器，主频高达3.1GHz，标配8G UDIMM内存，具备超快速的数据处理能力，对于双路扩展的支持更提升了该机的性能潜力。该机还为用户提供了8GB标配内存，最大硬盘容量可达到24TB，存储容量充足且支持组建RAID阵列，整机配置运行起来相当流畅。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/8i21_1.png" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/8i21_2.png" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/8i21_3.png" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/8i21_4.png" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">联想（iBM）x3250 M5 5458I21 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">超大内存丰富存储，iBM品质保证</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">低消耗高稳定，为企业节省能源消耗，4G/8G内存容量可供选择，4内存插槽高扩展性，总运行内存可达32G。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/8i21_t_1.png"></div>
        </div>
    </div>

     <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/8i21_t_2.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">高效节能，企业品质保证</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">运用直观的自动化工具进行监控和更新，以节省 IT 管理员的时间。抽拉式电源结构，强劲散热，高效节能。同时加快投入生产的速度并推动实现更好的投资回报。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">专注性能、稳定可靠</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 开放式硬盘托架，灵活选择硬盘类型，为用户带来了理想的空间占用和硬件扩展能力。紧凑合理的排线布局设计，使您用起来更舒心。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_4"><img src="${IncPath}/images/8i21_t_3.png"></div>
        </div>
    </div>
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/8i21_t_4.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">灵活升级，让办公很轻松</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">在服务器上激活集成管理模块后，您可以进行多次升级。同时，仍有两个PCLEx8扩展槽空出，未来业务增长时供您升级使用。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >产品型号：x3250 M5 5458I21 4x3.5"易插拔硬盘型号 <br />
            产品类型：机架/1U <br />
   ...
   <dl class="R730_dl">
       ...
       <dd >处理器型号：英特尔® 至强® 处理器 E3-1220v3 3.1GHz 4核 <br />
            标配数量/最大支持数量：  1颗 <br />
            处理器主频/缓存： 3.1Ghz/8M <br />
            插槽数量/QPI:PCIe 3.0 x8 (x8 电子) 全高半长 1个共享的管理端口 <br />
...
<!--          <dl class="R730_dl">
   ...
   <dl class="R730_dl">
      ...
      内存插槽数量：4个 <br />
       ...
       <dd >     标配容量/最大支持：开放式硬盘托架，最大支持4块3.5英寸易插拔硬盘
        </dd>
   </dl>
   <dl class="R730_dl">
       <dt class="red fon_16 fon_w">RAID支持</dt>
       <dd > ServerRaid C100 Raid 0,1,10
        </dd>
   </dl>
         <dl class="R730_dl">
