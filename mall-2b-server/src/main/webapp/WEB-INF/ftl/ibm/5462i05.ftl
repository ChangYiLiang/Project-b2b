...
<script type="text/javascript" src="${IncPath}/js/IBM5462i05.js"></script>
...
<div class="Large_box">
	...
	<#else>
		...
		<input type="hidden" name="goodsId" value="23">
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							...
							<option selected="selected">X3650 M5 5462I05</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="12650" id="145">System x3650 M5 5462I05</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：System x3650 M5 5462I05属于双路2U机架服务器，支持1-2颗CPU</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="146">1颗英特尔® 至强六核® 处理器E5-2603 v3 1.6GHz 8MB缓存 5GT/s DMI（包含价格中）</option>
						   ...
						   <li>
								...
								<a style="color:blue">提示：12个DIMM插槽，最大支持扩展384GB</a>
								<select class="form-control selectpicker">
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">联想（iBM）x3650 M5 5462i05</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">x3650 M5 5462i05是功能强大的通用型2U、两路机架式服务器，可优化用于支持大数据、分析和云环境。是企业用户的不二之选。高度集成化的设计让该机在性能和扩展能力方面都有着不错的表现。搭载Intel E5至强处理器，整形浮点等运算能力有了改进，尤其在高性能计算的表现有了大幅度提高。同时，选用业界最为领先的DDR4 内存，采用最新的512e硬盘标准，磁盘容量有效提高7-10%。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/5462i05_1.png" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/5462i05_2.png" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/5462i05_3.png" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/5462i05_4.png" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">联想（iBM）x3650 M5 5462i05 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">高速内存，您的理想之选</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">高速DDR4 2133内存，容量可达768GB，高于上代产品的内存容量，计算性能提高12%。24个内存插槽，满足不断升级的扩展需求。为未来中小企业的业务扩展提供优质解决方案。</span>
                    </li>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/62i05_t_2.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">全新硬件平台，高性能、低消耗</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">采用目前主流的双路机架式方案，该机配备新一代硬件平台，整机业务兼容能力强大，可为中小企业用户提供多种服务。服务器呈现出显着的节能优势，扩展了工作温度的范围、双区风冷以及主/备电源模式等，整体性能不错，达到企业高性能、低能耗的需求。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">海量存储、享受大容量快速运行</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 标配8个2.5英寸盘位，通过加装组件，可扩展至16个，运行快速。凭借高性能、多功能的2U双插槽System 3650 M5机架服务器，不间断运行大的工作负载并可获得快速的业务洞察力。优化从云到大数据的各种工作负载。</span>
                    </li>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/62i05_t_4.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">灵活硬件扩展，运行稳定可靠</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">服务器可配备双路至强E5处理器，完整的出厂硬件配置方案让该机可更快部署使用。丰富的硬件扩展能力让这款服务器可在后期进行功能化升级。可冗余的电源带来更高的运行可靠性。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >产品型号：x3650 M5 5462I05 8x2.5"热插拔硬盘型号<br />
            产品类型：机架/2U <br />
