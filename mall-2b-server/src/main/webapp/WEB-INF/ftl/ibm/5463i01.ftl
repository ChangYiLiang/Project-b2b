...
<script type="text/javascript" src="${IncPath}/js/IBM5463i01.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							...
							<option selected="selected">X3550 M5 5463I01</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="14300" id="133">System x3550 M5 5463I01</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：System x3550 M5 5463I01属于双路1U机架服务器，支持1-2颗CPU</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="134">1颗英特尔® 至强六核® 处理器E5-2603 v3 1.6GHz 8MB缓存 5GT/s DMI（包含价格中）</option>
						   ...
						   <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="137">M1215 Raid 0,1, 12Gbps带宽，可升级到无缓存/闪存的Raid 5</option>
								</select>
							</li>
							 <li>
								<span class="P_m">PCIe插槽 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="138">PCIe 3.0 x8 (x8 电子) 全高半长 1个共享的管理端口</option>
								</select>
							</li>
							  <li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">联想（iBM）x3550 M5 5463i01</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">x3550 M5 5463i01 是一款兼顾成本和密度的1U两路关键业务服务器，是小中型甚至大型企业的良好选择。它提供良好的性能，按需付费的灵活性以及有助于提高服务器管理能力的特性。它采用节能设计、高性能处理器、大容量高性能DDR4内存，非常适合关键业务应用和云部署使用。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/5463i01_1.png" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/5463i01_2.png" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/5463i01_3.png" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/5463i01_4.png" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">联想（iBM）x3550 M5 5463i01 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">卓越性能，超大容量</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">1U机架式外观降低了整机的空间占用和用户的运维成本，高度集成化的设计则让该机在性能和扩展能力方面都体现出了不俗的素质，出色的硬盘支持能力，可承担大容量的数据存储任务。</span>
                    </li>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/62i45_t_2.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">保密性强，安全运行</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">安全认证机制，可有效防止对系统固件的侵入，搭载TPM和自加密硬盘等加密措施，为客户呈现硬件级的安全解决方案。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">可靠性保证，节省成本</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 从设计，选料，生产到服务实现端到端的可靠性保证，预测性故障分析和智能诊断工具有助于缩短停机时间和降低成本，为客户实现业内低的故障率和高的无故障运行时间。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_4"><img src="${IncPath}/images/5463i01_t_3.png"></div>
        </div>
    </div>
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/62i45_t_4.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">提供恰到好处的解决方案</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">如果您是小型环境的储存，备份，云计算，应用软件开发者或服务提供商，此服务器能在有限的1U空间内为客户提供平衡了网络存储和计算密度的服务器解决方案。多项独有设计，既重视性价比，又留有升级余地。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >  处理器型号：英特尔® 至强® 处理器E5-2603 v3 1.6GHz 6核<br />
              标配数量/最大支持数量： 1颗/ 2颗 <br />
             处理器主频/缓存： 1.6Ghz/15M <br />
...
<!--          <dl class="R730_dl">
   ...
   <dl class="R730_dl">
       ...
       <dd > M1215 Raid 0,1, 12Gbps带宽，可升级到无缓存/闪存的Raid 5
        </dd>
   </dl>
         <dl class="R730_dl">
       <dt class="red fon_16 fon_w">网卡</dt>
       <dd >  网卡控制器：四口千兆网卡，支持I/O虚拟化等功能
        </dd>
   </dl>
   <dl class="R730_dl">
