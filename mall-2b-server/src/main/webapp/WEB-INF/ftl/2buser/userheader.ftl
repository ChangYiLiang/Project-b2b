...
<script>
	requirejs.config({
		shim: {
			"2bjs/jqslide": ['jquery'],
			"2bjs/breathLoopAll": ['jquery']
		}
	});
	requirejs(['2bjs/jqslide', '2bjs/breathLoopAll']);
</script>
<style>
	.clearfix li a,.remenci a,.dakuang a{text-decoration:none;}
</style>
<!--
...
<div class="nav_wrp">
        ...
        <div class="nav_center nav_center3">
            <div class="nav_left">
				...
				<#else>
                	...
                	<span><a style="text-decoration:none" href="${BasePath}/i9he/toRegister.do" target="_self">注册</a></span>
				</#if>
            </div>
            <div class="nav_right">
                <ul class="clearfix">
                    ...
                    <li class="nav_xiaoxi">消息中心<span class="xiaoxi_sp1">(${messageCount!0})</span> <em class="you1"></em>
                        <ul class="liebiao1 liebiao2">
                            <li class="xiugai1"><a href="${BasePath}/message/list.do" class="xiugai2">活动消息</a></li>
                            <li class="xiugai1">   <a href="${BasePath}/message/list.do" class="xiugai2">与我相关</a>
                                <span class="my_xiaoxi">${messageCount!0}</span>
                            </li>
    ...
    <div class="nav_center">
        <a href="${BasePath}">
        	<div class="nav_logo" style="background:url(${BasePath}/images/2bmain/9helogocha.png) no-repeat left bottom;width:280px;height:112px;float:left;padding-left:35px;position:relative;left:-52px;top:22px"></div>
        </a>
        <div class="nav_daohang">
            <form action="${BasePath}/i9he/search.do" method="get" accept-charset="utf-8"  class="ar_so_3">
                <input type="text" style="height:44px" class="ar_so_1" placeholder="产品名称/型号" name="keyword" value="${(searchModel.keyword)!''}"/>
	        ...
	        <#else>
	        	<div class="shop_wap clearfix">
	                ...
	                <div class="shop_con1">
	                    <div class="zhedang"></div>
	                    <div class="f1">最新加入的商品</div>
	                    <div class="f2">您还未登录，<strong><a href="${BasePath}/login.do" style="color:#1b9d97">马上登录</a></strong> 查看购物车吧！</div>
	                    <div class="f3">
	                    </div>
	                </div>
	            </div>
...
requirejs(['jquery'], function() {
	$(function(){
		$(".delete").click(function(){
			var path="${BasePath}";
			var url =path+"/i9he/cart/delete.do";
			var data={
					"id":$(this).attr("data")
				};
