...
<meta charset="utf-8" />
		...
		.div-login{width:350px;height:550px;border:1px solid #2679b9;margin:0px auto;margin-top:40px;background-color:white}
		...
		.toMerchantRegist{padding-left:70px}
		</style>
</head>
<body>
	<div class="div-login">
			<div class="login-top">
				...
				<span>欢迎注册九河互联企业用户！</span>	
			</div>
			<form action="#" id="form_cl" name="form_cl">
				<div class="form-group other-group" style="height:80px">
					<i class="fa fa-user fa-lg"></i>
					<input class="form-control required" type="text" placeholder="输入企业名" name="mailName" id="mailName"/>
				</div>
				<div class="form-group other-group" style="height:40px">
					<i class="fa fa-user fa-lg"></i>
					<input class="form-control required" type="text" placeholder="输入企业英文简码" name="usrMerchant" id="usrMerchant"/>
				</div>
				<div class="form-group other-group" style="height:40px">
					<i class="fa fa-user fa-lg"></i>
				...
				<div class="form-group other-group" style="height:20px">
				...
				<div style="position: relative;top:8px;">
						<img src="validcode.do" alt="" onclick="this.src='validcode.do?_t=' + Math.random()" style="height:34px;position:relative; left: 200px;top:-22px;" />
				</div>	
				...
				<div class="login-foot login-foot2">
					...
					<span class="foot2-span">已有九河企业账号?</span>
					<span><a id="toLogin" href="${BasePath}/controller/main.do">点击登录</a></span>
					<span style="left:60px;"><a href="${BasePath}/i9he/toRegister.do">普通用户注册</a></span>
				</div>
			</form>
	</div>
</body>
