...
<div class="bg-top">
	...
	<a style="width:130px;color:white;margin-top:15px;border-radius:0px;margin-right:-32px;font-weight:normal" class="pull-right other-a" href="${BasePath}/mark/usercharge.do">返回>></a>
	<a style="width:130px;color:white;font-weight:normal;margin-top:15px;border-radius:0px;margin-right:36px" class="btn-primary btn pull-right a-flag" href="#" data-toggle="modal" data-target="#myModal">立即充值</a>
	</p>	
</div>
...
<style>
	...
	.a-flag:hover{color:white !important}
	/*弹窗css*/
