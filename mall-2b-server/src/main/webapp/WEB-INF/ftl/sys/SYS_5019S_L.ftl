...
<script type="text/javascript" src="${IncPath}/js/SYS-5019S-L.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							<option selected="selected">美超微1U-SYS-5019S-L</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="2800" id="423">X11SSL-F</option>
								</select>
							</li>
							 <li>
							...
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="457">英特尔®C232服务器芯片组</option>
								</select>
							</li>
						   ...
						   <li>
								...
								<select class="form-control selectpicker">
									...
									<option value="4800" id="432">64GB DDR4 ECC 2133Mhz （4个插槽，最高64GB）[RMB4800.00]</option>
								</select>
							</li>
							 <li>
								...
								<select class="form-control selectpicker">
									...
									<option value="2400" id="438">6TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB2400.00]</option>
								</select>
							</li>
							 <li>
								<span class="P_m">网卡 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="439">双英特尔®i210-AT以太网控制器（内置）</option>
								</select>
							</li>
							 <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="441">PCI-E 3.0 x8 AOC插槽x1个</option>
								</select>
							</li>
							  <li>
								<span class="P_m">电源 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="442">200W 低噪交流电源持续供电</option>
								</select>
							</li>
						</ul>
					</li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 " style="margin-top:-60px">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">SuperServer  SYS-5019S-L</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">SuperServer  SYS-5019S-L是一款1U机架式服务器，专为主流服务器应用程序需求而生。具备最高整合水准、最大性能、最佳灵活性与超凡价值。是企业应用、虚拟化需求、数据中心、云端计算的最佳首选方案。凭借业内领先的性能和极具竞争力的价格，客户的需求能得到最大程度的满足。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5019sl_2.png" height="317" width="416" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/Sup_5019sl_1.png" height="317" width="416" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/Sup_5019sl_3.png" height="317" width="416" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5019sl_4.png" height="317" width="416" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">SuperServer  SYS-5019S-L特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">高硬盘容量 节省成本</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">该机硬盘的扩展性得到了前所未有的加强，4块可选的3.5英寸SATA硬盘，多硬盘槽位可以将硬盘容量最大增至6TB，出色的硬盘支持能力，可承担大容量的数据存储任务。同时，1U机架式外观降低了整机的空间占用和用户的运维成本。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/su_5019s_1.png"></div>
        </div>
    </div>

     <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_2.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 "> 灵活支持</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">支持酷睿i3 v6，奔腾，赛扬等多种主流操作系统，是能适应核心级应用的新一代服务器。其中，最值得推荐的是英特尔®Xeon®处理器e3-1200 v5，以超强的性能和超高的性价比，满足中小企业的业务需求。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    ...
                    <li class="H_wen">
                        <span class="w_1"> 为保证极端工作条件下的出色性能，服务器只选用最高质量的器件材料。同时遵照严格的设计、实施、制造标准和ISO 标准，以确保其产品具备最高品质和可靠性。这些质保措施不仅优化了系统性能，还尽可能减少了系统的停机时间。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_4"><img src="${IncPath}/images/su_5019s_3.png"></div>
        </div>
    </div>
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_4.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">出色的售后服务</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">为确保全球客户的绝对满意，美超微的所有产品均提供一份全面的质保和更换服务。美超微拥有高速响应的经销商渠道和专业技术支持团队，全年提供 7x24 的支持服务与备件更换服务。 </span>
            </li>                
        </ul>
