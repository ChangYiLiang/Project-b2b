...
<script type="text/javascript" src="${IncPath}/js/SYS-5018D-MTF.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							...
							<option selected="selected">美超微1U-SYS-5018D-MTF</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="3600" id="455">X11SSL-F</option>
								</select>
							</li>
							 <li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 " style="margin-top:-60px">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">SuperServerSYS-5018D-MTF</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">SYS-5018D-MTF作为一款入门级1U服务器，其紧凑的机身内搭载了Intel的Xeon E3-1265 v4系列处理器，强劲的计算性能可充分满足中小型企业所需。不光如此，5018D-MTF凭借出众的存储密度、高度灵活的设计和超可靠的性能，并支持高压直流电源，充分满足电信、互联网云计算数据中心的供电需求，成为云时代的绝佳选择。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5018dmtf_4.png" height="317" width="416" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/Sup_5018dmtf_3.png" height="317" width="416" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/Sup_5018dmtf_2.png" height="317" width="416" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5018dmtf_1.png" height="317" width="416" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">SuperServerSYS-5018D-MTF 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">承载高密度运算，成本可控</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">建立在英特尔®至强®处理器系列的领先性能和突破性I/O能力的基础上，全新的计算平台可实现高达50%的性能提升和50%电力节约，能够完美地担当中小IT企业的基础架构，承载计算密集型WEB应用、协作和业务线应用程序等任务，有效降低成本预算。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/su_h12_5.png" height="286" width="482" alt="" /></div>
        </div>
    </div>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_2.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">扩展性强大，丰富存储</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">服务器的内存采用了DDR3规格，最高容量可达32GB，为未来留下了充足的扩展空间。同时支持4个3.5“热插拔硬盘，提供高达6TB丰富的存储空间，可在后期使用中为用户提供更高的配置灵活性，性能出色的基础配置更提升了整机的初期使用和配置效率。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">灵活管理，一切尽在掌控</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> IPMI2.0智能平台管理接口，基于开放的行业标准和协议，是一款包括配置、部署、电力规划、能源管理的直观的生命周期管理工具，使得系统管理便捷、轻松，从而提升企业生产力、节省运营成本，为中小企业成长加速。</span>
                    </li>
         ...
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_h12_1.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">黄金级电源供电 </span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">350W黄金级电源的转换效率高达91.23%，相比传统电源能效标准高出1.23%，搭配5个4-pin前置静音风扇，散热范围能够顾及到电源内部的各个元器件，为长久稳固工作提供最具效力的工作环境。 </span>
            </li>                
        </ul>
