...
<script type="text/javascript" src="${IncPath}/js/5038ML-H24TRF.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							...
							<option selected="selected">美超微3U-5038ML-H24TRF</option>
						</select>
					</li>
				</ul>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="52000" id="486">X10SLE-DF</option>
								</select>
							</li>
							 <li>
						   ...
						   <li>
							 ...
							 <li>
							  ...
							  <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="487">2000W 直流交流高功率冗余电源持续供电</option>
								</select>
							</li>
						</ul>
					</li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 " style="margin-top:-60px">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">SuperServer  SYS-5038ML-H24TRF</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">SuperServer  SYS-5038ML-H24TRF服务器采用新型的3U机架式结构设计，严苛的工业标准，使其面对企业的业务需求不断增长，它应对自如，保证您的系统运转可以日夜兼程。该机管理工具系统相当全面，可以轻松实现系统部署、集成、维护和管理。针对关键任务型应用程序的计算速度可与可靠性为主要焦点，提供了业界最快、最强大的服务器解决方案。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5038h24_1.png" height="317" width="416" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/Sup_5038h24_2.png" height="317" width="416" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/Sup_5038h24_1.png" height="317" width="416" alt="" /></li>
                          <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_5038h24_4.png" height="317" width="416" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">SuperServer  SYS-5038ML-H24TRF特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">易于服务，节省空间</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">3U的机箱支持热插拔，提高了系统对灾难的及时恢复能力、扩展性和灵活性等，每个节点有独立的网络管理接口支持带KVIVI的IPMI2.0的技术，在操作系统不响应或未加载的情况下其仍然可以进行开关机、信息提取等操作。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/su_h12_3.png" height="286" width="482" alt="" /></div>
        </div>
    </div>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_h12_2.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 "> 无与伦比的运算速度</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">超微服务器致力于高性能超级运算，凭借PCL-E3.0扩展槽，双千兆以太网和QDR（40Gbps）inniband端口，可提供大规模并行处理能力及无与伦比的网络灵活性，这些系统为高质量高密集运算的应用程序提供了最佳优化。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">超强设计 极致节能</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 服务器设计采用的是80PLUS白牌冗余电源，高达94%的利用率，搭载节能主板和企业级服务器可管理优化冷却系统，凸显出节能、高效率、散热性能好的特点，大大的减轻了用户的能源负担。</span>
                    </li>
         ...
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_4.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">理想业务平台 </span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">超微高性能服务器完美的技术平台，即使是最苛刻的应用也能应付自如。是地震处理、生物化学传真、天气和气候建模、信号处理、金融计算、交通运输工程、机械工程和数据分析理想的平台。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >产品型号：SYS-5038ML-H24TRF <br />
            产品类型：3U机架式服务器 <br />
            产品尺寸：高度：132.5mm（5.21英寸）x宽度：444.5mm（17.5英寸）x深度：791.2mm（31.15英寸） <br />
