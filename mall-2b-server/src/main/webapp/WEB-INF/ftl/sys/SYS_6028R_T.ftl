...
<script type="text/javascript" src="${IncPath}/js/6028R-T.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							...
							<option selected="selected">美超微2U-6028R-T</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="11000" id="462">X10DRi</option>
								</select>
							</li>
							 <li>
							...
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="468">英特尔®C236服务器芯片组</option>
								</select>
							</li>
						   ...
						   <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker">
									<option selected="selected" value="550" id="443">500GB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB550.00]</option>
									<option value="700" id="444">1TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB700.00]</option>
									<option value="1000" id="445">2TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB1000.00]</option>
									<option value="1200" id="446">3TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB1200.00]</option>
									<option value="1300" id="447">4TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块[RMB1300.00]</option>
									<option value="2400" id="508">6TB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块（6块3.5可选）[RMB2400.00]</option>
								</select>
							</li>
							 <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="471">PCI-E 3.0 x8 插槽 x3个</option>
									<option value="0" id="472">PCI-E 3.0 x16 插槽 x1个</option>
								</select>
							</li>
							  <li>
								<span class="P_m">电源 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="473">650W 直流交流高功率电源持续供电</option>
								</select>
							</li>
						</ul>
					</li>
...
<div class="box_center">
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 " style="margin-top:-60px">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">SuperServer SYS-6028R-T</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">SuperServer SYS-6028R-T 针对业务关键型工作负载（包括云计算、虚拟化需求）将超凡的正常运行时间和高性能融为一体。此款强大的服务器提供了一种易于使用的节能智能型机架解决方案，其按需购买设计有助于管理风险。凭借更高的计算能力功耗比、最新的英特尔至强 E5-2603 v3 系列处理器、先进的内存支持、针对需要大量存储空间的企业的更高磁盘容量，SYS-6028R-T 可以提供均衡的性能与密度。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_6028rt_4.png" height="317" width="416" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/Sup_6028rt_2.png" height="317" width="416" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/Sup_6028rt_3.png" height="317" width="416" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/Sup_6028rt_1.png" height="317" width="416" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">SuperServer  SYS-6028R-T特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">均衡性能与密度</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">IPMI 2.0支持智能平台管理接口，实时监控服务器的状态，查看日志文件，并可实现强大的远程KVM 功能，让管理员在远端即可对系统进行完全控制。 具有极高灵活性，易于部署、集成、维护和管理。</span>
                    </li>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_3.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">高弹性、轻负载</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">内置16条DDR4内存插槽，内存可以扩充至高达1T。带宽数据提高2倍，完全能够满足内存与处理器之间的数据传输要求。搭载650W黄金级热插拔电源，功率强大，同时避免系统因电源故障导致宕机，提高整体可靠性。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">高可用、高扩展硬盘存储</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 服务器最大可支持6块3.5英寸（企业级）热插拔SATA规格硬盘驱动器，最大硬盘存储容量可达6TB，如此强大的扩展性足以支撑关键任务的运行，满足资源密集型应用的需要，是企业的最佳选择。</span>
                    </li>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/su_5019s_2.png" height="286" width="482" alt="" /></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">支持广泛工作负载 </span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">支持最新的Intel Xeon E5-2603 v3系列处理器，在应对当前高性能计算和组建集群、部署各种云服务方面，均能提供良好的支撑。非常适用于金融、证券、交通、邮政、电信、能源等对服务器性能、可扩展性及可靠性要求苛刻的行业数据中心和远程的企业环境。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >  标配容量/最大支持：500GB 7.2K RPM SATA 6Gbps 3.5英寸(企业级)硬盘x1块/6块
        </dd>
   </dl>
   <dl class="R730_dl">
