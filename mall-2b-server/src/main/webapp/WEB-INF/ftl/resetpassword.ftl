...
<meta charset="utf-8" />
		...
		.div-login{width:350px;height:400px;border:1px solid #2679b9;margin:0px auto;margin-top:80px;background-color:white}
...
<body>
	<div class="div-login">
			...
			<#if state == 1>
				<h4 class="text-center" style="margin-top: 40%">
			...
			<form action="#" id="form_cl" name="form_cl">
				<div class="form-group other-group" style="height:85px">
					<i class="fa fa-user fa-lg"></i>
					<input class="form-control " type="text" placeholder=" 输入用户名" name="username" id="username" 
						required data-required-message="用户名不能为空"/>
				</div>
				
				<div class="form-group other-group" style="height:45px">
					<i class="fa fa-lock fa-lg"></i>
					<input class="form-control " type="password" placeholder=" 输入新密码" name="password" id="password" 
						required data-required-message="新密码不能为空"/>
				</div>
				
				<div class="form-group other-group" style="height:65px">
					<i class="fa fa-lock fa-lg"></i>
					<input class="form-control " type="password" placeholder=" 输入确认密码" name="confirmpassword" id="confirmpassword" 
						data-equal-to="#password" 
						required data-required-message="确认密码不能为空"/>
				</div>
				
				<div class="form-group other-group" style="height:20px">
					<input type="submit" class="btn sub-btn" value="立 即 更 改" />
					<input id="reset" type="reset" value="重 置" style="display:none"/> 
				</div>
				<div class="login-foot login-foot2">
					<span class="glyphicon glyphicon-share-alt fa-lg"></span>
					<span class="foot2-span">已有九河账号?</span>
					<span><a id="toLogin" href="${BasePath}/i9he/login.do">点击登录</a></span>
				</div>
			</form>
			</#if>
	</div>
