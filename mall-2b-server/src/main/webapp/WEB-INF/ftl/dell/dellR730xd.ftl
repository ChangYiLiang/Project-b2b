...
<script type="text/javascript" src="${IncPath}/js/DellR730XD.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select" onblur="getindex()">
							...
							<option selected="selected">PowerEdge R730XD</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="13200" id="99">2U机架式</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：R730XD属于双路机架服务器，支持1-2颗CPU</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="100">2颗英特尔至强六核 E5-2603 v4 1.70GHz,15M缓存,6.4GT/s QPI（包含价格中）</option>
						   ...
						   <li>
							 ...
							 <li>
								...
								<a style="color:blue">备注：硬盘最大支持8个3.5英寸或16个2.5英寸</a>
								<select class="form-control selectpicker">
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="36">集成Broadcom 5720四端口千兆网卡</option>
								</select>
							</li>
							 <li>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="101">6个PCIe 3.0</option>
								</select>
							</li>
							  <li>
...
<ul class="nb_flag">
    ...
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">戴尔PowerEdge R730XD</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">戴尔PowerEdge R730XD是一款采用了全新硬件打造的具备中高端性能表现的2U机架式服务器，该机标配有单颗第三代英特尔至强E5处理器，内存升级为DDR4规格，具备强大的基础性能表现。R730XD与R730的不同之处在于，R730xd侧重于存储方面，它可以提供更高密度的存储能力。服务器所使用的机框采用了全新设计，拥有了更为丰富的内部空间，功能和性能强大的主板为整机提供了充足的硬件扩展槽位，可实现硬件性能的大幅升级和优化，可满足不同等级用户的使用需求。</span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/R730_XD_1.png" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/R730_XD_2.png" alt="" /></li>
                          <li class="R730_w_2 R230_1" style="margin-left:10px"><img src="${IncPath}/images/R730_XD_3.png" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/R730_XD_4.png" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">PowerEdge R730XD 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">卓越性能提升</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">戴尔 PowerEdge R730XD服务器具有比上一代产品有着更大的内存和更高的I/O带宽，因此缩短了响应时间，可为中小企业用户、大型企业和组织的部门和远程办公室提供更高的性能，让服务器发挥出更出色成效，效果更优秀。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/R73_4.png"></div>
        </div>
    </div>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:76px;"><img src="${IncPath}/images/R73_2.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">定位于企业级</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">服务器定位企业级用户，以新一代至强E5处理器为核心，拥有4GB高规格内存支持能力，提供了明显优于前代的扩展能力，可承载更多业务需求，满足不同用户的实际需要。 </span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">灵活均衡部署</span>
                        <div class="tit_xian"></div>
                        <br/>
                    </li>
                    <li class="H_wen">均衡的默认配置方案让整机的部署更加高效简单，为数据中心提供极高灵活性，在苛刻的环境中表现也毫不逊色，大幅提高了运营效率和灵活性，适合任何规模的应用和环境。</span>
                    </li>
         ...
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:54px;"><img src="${IncPath}/images/R73_1.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">顺应云计算时代而生</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">戴尔 PowerEdge R730XD配备300G硬盘容量，高支持达24个DDR4 DIMM插槽，可以有效提供更多线程执行所需的内存容量，在虚拟机和云计算应用上有明显的优势。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
      ...
      内存插槽数量：24个DIMM插槽、支持DDR4
         ...
         <dl class="R730_dl">
       <dt class="red fon_16 fon_w">存储</dt>
       <dd > 硬盘接口类型：SAS <br>
       标配容量/最大支持：300GB 10K RPM SAS 6Gbps 2.5英寸热插拔硬盘*1块/最大支持12块盘 <br>
       硬盘描述：24块2.5英寸 SAS/SATA硬盘 <br>
       热插拔盘位：支持热插拔 <br>
       磁盘控制器：H330 <br>
        </dd>
   </dl>
   <dl class="R730_dl">
       ...
       <dd > 内置PERC H330 阵列控制器（支持raid0,1,5,10,50）
         ...
         <dl class="R730_dl">
       <dt class="red fon_16 fon_w">扩展槽</dt>
       <dd >3x半长半高PCI-Ex8插槽（x16接口） <br>
       2x全长半高PCI-Ex16插槽（x16接口） <br>
		1x全长全高PCI-Ex8插槽（x16接口）
   ...
   <dl class="R730_dl">
       <dt class="red fon_16 fon_w">阵列卡</dt>
       <dd >标配1个智能PERC H330阵列卡
        </dd>
   </dl>
   <dl class="R730_dl">
   ...
   <dl class="R730_dl">
       <dt class="red fon_16 fon_w">系统管理</dt>
       <dd >OpenManage Essentials控制台  <br>
			带有Lifecycle Controller的iDRAC8

        </dd>
   </dl>
         <dl class="R730_dl bd_last">
       <dt class="red fon_16 fon_w ">系统支持</dt>
       <dd > Microsoft Windows Server 2008/2012 SP2,x86/x64(x64含Hyper-VTM) <br>
       Microsoft Windows Server 2008/2012 R2, x64(x64含Hyper-VTM) <br>
