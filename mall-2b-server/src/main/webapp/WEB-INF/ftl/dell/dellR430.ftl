...
<script type="text/javascript" src="${IncPath}/js/DellR430.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select" onblur="getindex()">
							...
							<option selected="selected">PowerEdge R430</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="9570" id="60">1U机架式</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：R430属于双路机架服务器，支持1-2颗CPU</a>
								<select class="form-control selectpicker">
						   ...
						   <li>
							 ...
							 <li>
								...
								<a style="color:blue">备注：硬盘最大支持4个3.5英寸或10个2.5英寸</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="77">300GB 10K RPM SAS 6Gbps 2.5英寸非热插拔硬盘*1块（包含价格中）</option>
							 ...
							 <li>
								...
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="87">3个PCIe 3.0，2个PCIe 2.0</option>
								</select>
							</li>
							  <li>
								...
								<select class="form-control selectpicker">
									...
									<option value="1500" id="89">热插拔单电源,550W  [RMB1500.00] </option>
								</select>
							</li>
						</ul>
					</li>
...
<ul class="nb_flag">
    ...
    <div class="L_box bac_f ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">戴尔PowerEdge R430 </span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> PowerEdge R430是强大的双路入门级机架式服务器，可为空间有限的数据中心提供卓越的性能，它非常适用于备份服务器或程序开发服务器。利用各种基于PCle的产品可提供大量I/O功能借助PCle 3.0， 您可以获得两倍于PCle 2.0的互连带宽（8 Gbps）并支持更高效的数据中心解决方案， 如GPU处理加速、电源管理和联网。借助带生命周期控制器的集成式戴尔远程访问控制器8（IDRAC8），自动执行操作系统部署、服务器配置和更新，进而加快投入生产的速度和推动实现更好的投资回报。
                        </span>
                    </li>
                ...
                <div class="M_box_L_2  R730_2 ">
                    <ul class="R930_2">
                        <li class="R730_w_1 R230_1"><img src="${IncPath}/images/430_1.png" alt="" /></li>
                         <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/430_2.png" alt="" /></li>
                          <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/430_3.png" alt="" /></li>
                            <li class="R730_w_1 R230_1"><img src="${IncPath}/images/430_4.png" alt="" /></li>
                    </ul>
    ...
    <div class="tedian_box">
        <div class="R730_xian">
            <span class="fon_24 fon_w hui_f bac_3 R730_sp">PowerEdge R430 特点</span>
        </div>
         <div class="L_box  ">
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">提供顶级内存性能</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1">借助最新的Intel® Xeon®处理器E5-2600 v4产品系列，提升处理各种工作负载时的性能。配备 12 个 DIMM 插槽和 DDR4 内存，可提升性能并增加内存容量吞吐量。非常适合高性能计算 (HPC)、Web技术和基础架构横向扩展。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/R430_1.png"></div>
        </div>
    </div>
    ...
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/330_4.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">提高运营效率</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">通过使用带有生命周期控制器的集成戴尔远程访问控制器 8 (iDRAC8) 自动执行部署，加快投入生产的速度并推动实现更好的投资回报。运用直观的自动化工具进行监控和更新，以节省 IT 管理员的时间。借助高能效的处理器、内存、电源以及新风 2.0 功能，控制能源预算。</span>
            </li>                
        </ul>
        ...
        <div class="M_box">
            ...
            <div class="M_box_R tiyan_3 R730_1 ">
                <ul class="M_box_R ">
                    <li class="H_t">
                        <span class="tit_1 fon_24 hui_3 ">掌握硬件最新状态</span>
                        <div class="tit_xian"></div>
                    </li>
                    <li class="H_wen">
                        <span class="w_1"> 通过 OpenManageMobile，随时随地监控和管理DELL PowerEdge服务器的运行状况和可用性，从而控制数据中心的可用性。OpenManage Essentials 现在还提供服务器配置管理功能，可自动执行一对多 PowerEdge 裸机服务器和操作系统部署、快速一致的配置复制，同时利用自动化偏移检测，确保符合您的期望。</span>
                    </li>

                </ul>
            </div>

                         <div class="M_box_L_2 R730_4"><img src="${IncPath}/images/R430_2.png"></div>
        </div>
    </div>
         <div class="L_box ">
    <div class="M_box">
     <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/R430_3.png"></div>
      <ul class="M_box_R">
            <li class="H_t">
                <span class="tit_1 fon_24 hui_3 ">全天候高级支持</span>
                <div class="tit_xian"></div>
            </li>
            <li class="H_wen">
                <span class="w_1">选择戴尔的高级支持服务ProSupport，即可在全天候直接电话联系或在线联系您当地的高级技术人员。无论您是只有一个办事处还是在世界各地拥有数百个办事处，都能采用这种简单灵活的方法来保护您的投资。 </span>
            </li>                
        </ul>
   ...
   <dl class="R730_dl">
       ...
       <dd >产品型号：PowerEdge R430 <br />
     产品类型：至强六核1U机架式服务器 <br />
     产品尺寸：高度：27cm（10.62英寸）x宽度：91cm（35.82英寸）x深度：61cm（24.01英寸） <br />
   ...
   <dl class="R730_dl">
       ...
       <dd >标配容量/最大支持： 1x4GB/384GB <br />
      内存类型/工作频率：  Non-ECC /2133MHz <br />
      内存插槽数量：12个DIMM插槽 <br />
