...
<script type="text/javascript" src="${IncPath}/js/DellR230.js"></script>
				...
				<ul class="P_control">
					<li>
						...
						<select class="form-control selectpicker" id="select">
							<option selected="selected">PowerEdge R230</option>
						...
						<ul class="P_box0">
							<li>
								...
								<select class="form-control selectpicker" >
									<option selected value="7150" id="1">1U机架式</option>
								</select>
							</li>
							 <li>
								<span class="P_m">处理器 :</span>
								<a style="color:blue">提示：R230属于单路机架服务器，仅支持1颗CPU</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="2">1颗英特尔®至强四核® E3-1220 v5 3.0GHz 8MB缓存 8GT/s DMI3（包含价格中）</option>
									<option value="936" id="3">1颗英特尔®至强四核® E3-1230 v5 3.4GHz 8MB缓存 8GT/s DMI3  [RMB936.00]</option>
									<option value="1415.70" id="4">1颗英特尔®至强四核® E3-1240 v5 3.5GHz 8MB缓存 8GT/s DMI3  [RMB1415.70]</option>
									<!--
									<option value="2503" id="4">1颗英特尔®至强四核® E3-1270 v5 3.6GHz 8MB缓存 8GT/s DMI3  [RMB2503.80]</option>
									-->
									<option value="8318.70" id="5">1颗英特尔®至强四核® E3-1280 v5 3.7GHz 8MB缓存 8GT/s DMI3  [RMB8318.70]</option>
								</select>	
							</li>
						   <li>
								...
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="6">4GB DDR4 ECC 2133Mhz（包含价格中）</option>
									<option value="900" id="7">8GB DDR4 ECC 2133Mhz [RMB900.00]</option>
									<option value="1800" id="8">16GB DDR4 ECC 2133Mhz [RMB1800.00]</option>
									<option value="3600" id="9">32GB DDR4 ECC 2133Mhz [RMB3600.00]</option>
									<option value="7200" id="10">64GB DDR4 ECC 2133Mhz [RMB7200.00]</option>
								</select>
							</li>
							 <li>
								<span class="P_m">硬盘 :</span>
								<a style="color:blue">提示：硬盘最大支持4个3.5英寸</a>
								<select class="form-control selectpicker">
									<option selected="selected" value="0" id="11">500GB 7.2K RPM SATA 6Gbps 3.5英寸硬盘（包含价格中</option>
									<option value="1000" id="12">1TB 7.2K RPM SATA 6Gbps 3.5英寸硬盘 [RMB1000.00]</option>
									<option value="1300" id="13">2TB 7.2K RPM SATA 6Gbps 3.5英寸硬盘 [RMB1300.00]</option>
									<option value="1600" id="14">4TB 7.2K RPM SATA 6Gbps 3.5英寸硬盘 [RMB1600.00]</option>
								</select>
							</li>
							 <li>
								<span class="P_m">芯片组 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="15">英特尔®C236</option>
								</select>
							</li>
							 <li>
								<span class="P_m">网卡 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="16">集成双端口千兆以太网卡（包含价格中）</option>
								</select>
							</li>
							 <li>
								<span class="P_m">RAID配置 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="17">内置PERC S110阵列控制器（包含价格中）</option>
								</select>
							</li>
							 <li>
								<span class="P_m">PCIe插槽 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="18">2个PCIe x16 G2插槽（内置）</option>
								</select>
							</li>
							  <li>
								<span class="P_m">电源 :</span>
								<select class="form-control selectpicker" >
									<option selected="selected" value="0" id="19">单个有线电源，250W（包含价格中）</option>
								</select>
							</li>
						</ul>
					</li>
			...
			<div class="M_box">
				...
				<div class="M_box_R tiyan_3 R730_1 ">
					...
					<div class="M_box_L_2  R730_2 ">
						<ul class="R930_2">
							<li class="R730_w_1 R230_1"><img src="${IncPath}/images/R230_1.png" alt="" /></li>
							 <li class="R730_w_1 R230_1"  style="padding-left:5px;"><img src="${IncPath}/images/R230_2.png" alt="" /></li>
							  <li class="R730_w_1 R230_1" style="margin-left:10px"><img src="${IncPath}/images/R230_3.png" alt="" /></li>
								<li class="R730_w_1 R230_1"><img src="${IncPath}/images/R230_4.png" alt="" /></li>
						</ul>
					...
					<ul class="M_box_R ">
						...
						<li class="H_wen">
							<span class="w_1">R230服务器搭载了英特尔至强处理器E3-1200 v5系列的每个内核都能多提供33%的高速缓存，让您的应用程序发挥最大效用。4个DIMM插槽最高可配64 GB内存，有助于缩短响应时间，最新的第三代PCIe I/O插槽还能有效提高数据传输速率。</span>
							 ...
							 <div class="M_box_L_2 R730_3"><img src="${IncPath}/images/230_4.png"></div>
			</div>
		</div>

		 <div class="L_box ">
		<div class="M_box">
		 <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/230_3.png"></div>
		  <ul class="M_box_R">
				<li class="H_t">
					...
					<ul class="M_box_R ">
						...
						<li class="H_wen">
							<span class="w_1"> 以优化的配置将Dell PowerEdge服务器的性能、内存容量和嵌入式虚拟机管理程序选项与桌面虚拟化软件整合在一起，创建集中式最终用户计算环境，支持更多用户终端设备，从而简化管理、操作。</span>
							 ...
							 <div class="M_box_L_2 R730_4"><img src="${IncPath}/images/230_2.png"></div>
			</div>
		</div>
			 <div class="L_box ">
		<div class="M_box">
		 <div class="M_box_L_2 tiyan_6" style="margin-top:36px;"><img src="${IncPath}/images/230_1.png"></div>
		  <ul class="M_box_R">
				<li class="H_t">
