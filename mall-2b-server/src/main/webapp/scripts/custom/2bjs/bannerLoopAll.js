(function(){
	function breathLoop(speed){
		...
		function myFn(){
			$('.bannerLoop ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop2(speed){
		...
		function myFn(){
			$('.bannerLoop2 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop2 ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop3(speed){
		...
		function myFn(){
			$('.bannerLoop3 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop3 ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop4(speed){
		...
		function myFn(){
			$('.bannerLoop4 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop4 ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop5(speed){
		...
		function myFn(){
			$('.bannerLoop5 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop5 ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop6(speed){
		...
		function myFn(){
			$('.bannerLoop6 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop6 ul li').eq(num).stop(true,true).fadeIn();
...
(function(){
	function breathLoop7(speed){
		...
		function myFn(){
			$('.bannerLoop7 ul li').eq(num).stop(true,true).fadeOut();
			num++;
			if(num > imgMax){
				num = 0;
			}
			$('.bannerLoop7 ul li').eq(num).stop(true,true).fadeIn();
