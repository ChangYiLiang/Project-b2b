<div class="modal-header">
	...
	<h4 class="modal-title">新增标签分类</h4>
</div>
...
<div class="modal-body">
	<div class="row">
		<div class="col-md-12">
			<!-- BEGIN FORM-->
			<form action="create_category.do" id="form_cl" class="form-horizontal" method="POST">
				...
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" id="sortNo" name="sortNo" value="1" 
								required 
