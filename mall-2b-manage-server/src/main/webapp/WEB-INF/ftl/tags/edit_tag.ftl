<div class="modal-header">
	...
	<h4 class="modal-title">修改标签/关键字</h4>
</div>
...
<div class="modal-body">
	<div class="row">
		<div class="col-md-12">
			<!-- BEGIN FORM-->
			<form action="edit_tag.do" id="form_cl" class="form-horizontal" method="POST">
				...
				<div class="form-body">
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<input type="text" class="form-control" id="sortNo" name="sortNo" value="${tag.sortNo!1}" 
								required 
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<select name="type" id="type" class="form-control">
								...
								<option value="1" ${(tag.type==1)?string("selected","")}>关键字</option>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-md-7">
							<textarea name="remark" id="remark" class="form-control">${tag.remark!''}</textarea>
						</div>
					</div>
