		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb" style="background-color:#428bca">
						<li>
				...
				<div class="col-md-12">
					...
					<div class="portlet">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>${goods.goodsName}
							</div>
							<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
			...
			<form action="insertlist.do" method="POST">
			  	<ul class="list-group">
					...
					<div class="addflag">
						<li class="list-group-item">
							...
							<span>配件名称：</span>
							<input style="width:250px" type="text" class="form-control" name="itemname" required>
							<span>配件价格：</span>
					...
					<li class="list-group-item">
						<input type="submit" class="btn btn-primary" value="批量添加绑定配件">
					</li>
				</form>
			</ul>		
		</div>				
...
<style>
	.cutflag{position:relative;left:800px;top:-43px}
</style>
<script type="text/javascript">
	$(function(){
		$(".addbutton").click(function(){
			var cut  = "<a class='btn btn-primary cutflag'>删除</a>";
			var text = $(".addflag").html();
			$(".addflag").after(text+cut);
		})
	})
</script>
<script type="text/javascript">
	$(function(){
		$(document).on("click", ".cutflag", function(){  
			  $(this).prev().remove();
			  $(this).remove();
		}) 
	})
