			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="${BasePath}">
								配件分类中心<span style="color:red">【tip:每个商品下面的配件分类排序全部要不一样，相同的排序的会挤掉！！】</span>
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
					</ul>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	  ...
	  <form action="#" id="form_cll">
	  	<ul class="list-group">
			...
			<li class="list-group-item">
					<span>显示排序：</span>
					<input type="num" style="width:50px" class="form-control" name="sort" id="sort" value="1" required>
					<span style="color:red">【tip:每个商品下面的配件分类排序全部要不一样，相同的排序的会挤掉！！】</span>
			</li>
