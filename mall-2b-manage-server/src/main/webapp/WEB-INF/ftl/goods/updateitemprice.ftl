	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<style>
			 ...
			 #form_cll44 ul li input{width:163px}
			</style>
			<form action="#" id="form_cll44">		
		  	<ul class="list-group">
					<input type="hidden" name="goodsId" id="goodsId" value="${info2.goodsId}">
					<input type="hidden" name="itemId" id="itemId" value="${info2.itemId}">
					
			  		<li class="list-group-item">
			  			<span>配件名称：</span>
						<input style="width:400px" type="text" class="form-control" name="itemsName" id="itemsName" value="${info0.title}" disabled>
			  		</li>
			  	
			  		<li class="list-group-item">
			  			<span>所属商品：</span>
						<input style="width:400px" type="text" class="form-control" name="goodsName" id="goodsName" value="${info1.goodsName}" disabled>
			  		</li>
		  				
					<li class="list-group-item">
							<span>月付价格：</span>
							<input type="text" class="form-control" name="monthPay" id="monthPay" value="${info2.monthPay?default("0")}" required>
							
							<span>续月价格：</span>
							<input type="text" class="form-control" name="mrenewPay" id="mrenewPay" value="${info2.mrenewPay?default("0")}" required>
							
					</li>
					<li class="list-group-item">
							<span>季付价格：</span>
							<input type="text" class="form-control" name="quartPay" id="quartPay" value="${info2.quartPay?default("0")}" required >
							
							<span>续季价格：</span>
							<input type="text" class="form-control" name="qrenewPay" id="qrenewPay" value="${info2.qrenewPay?default("0")}" required >
							
					</li>
					<li class="list-group-item">
							<span>半年付费：</span>
							<input type="text" class="form-control" name="hyPay" id="hyPay" value="${info2.hyPay?default("0")}" required>
							
							<span>续半年付：</span>
							<input type="text" class="form-control" name="hrenewPay" id="hrenewPay" value="${info2.hrenewPay?default("0")}" required>
							
					</li>
					<li class="list-group-item">
							<span>年付价格：</span>
							<input type="text" class="form-control" name="yearPay" id="yearPay" value="${info2.yearPay?default("0")}" required >
							
							<span>续年付费：</span>
							<input type="text" class="form-control" name="yrenewPay" id="yrenewPay" value="${info2.yrenewPay?default("0")}" required >
							
					</li>
					<li class="list-group-item">
							<span>二年付费：</span>
							<input type="text" class="form-control" name="tyPay" id="tyPay" value="${info2.tyPay?default("0")}" required>
							
							<span>续二年付：</span>
							<input type="text" class="form-control" name="trenewPay" id="trenewPay" value="${info2.trenewPay?default("0")}" required>
							
					</li>
				</from>
				<li class="list-group-item">
						<button type="button" class="btn btn-primary" id="additem" onclick="javascript:$('#form_cll44').submit();">修改</button>
				</li>
			</ul>
