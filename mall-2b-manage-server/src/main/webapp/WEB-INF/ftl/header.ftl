		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown user">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
					<img alt="" src="${IncPath}/assets/img/<#if user.gender==1>avatar3_small.jpg<#else>avatar2_small.jpg</#if>"/>
					<span class="username">
						 ${user.username!''}(${user.nickName!'九河'})
					</span>
				...
				<!-- 	<li>
					...
					<li>
						<a href="javascript:Cl.showRemoteModalWindow(Cl.modalName,'${modifyPswPath}', {height: 430});">
							<i class="fa fa-arrows"></i> 修改密码
						</a>
					</li>
					<li>
